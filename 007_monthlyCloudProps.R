...
if (!file.exists("../results/values/monthly_cloudProps.rds")){
  ...
  saveRDS(df, file = "../results/values/monthly_cloudProps.rds")
} else {
  df = readRDS("../results/values/monthly_cloudProps.rds")
}
...
# saving plot to disk
ggsave(plot=meanplot, file = "../results/plots/cloudProps_monthly.png", dpi=600, device="png", width = 20, height = 10)
