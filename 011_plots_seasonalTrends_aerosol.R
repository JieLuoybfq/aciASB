...
paraStacks = lapply(paras, function(x){
  stack(list.files(paste0("../results/season/", x), pattern = "20.._s", full.names = TRUE))
})
...
trendDir <- function(y){
  ...
  # save output to disk
  for (p in paras){
    writeRaster(trendRasters[[p]][[1]][["slope"]], filename = paste0("../results/trends/aerosol_s1_slope_",p,".tif"), overwrite = TRUE)
    writeRaster(trendRasters[[p]][[1]][["pvalue"]], filename = paste0("../results/trends/aerosol_s1_pvalue_",p,".tif"), overwrite = TRUE)
    
    writeRaster(trendRasters[[p]][[2]][["slope"]], filename = paste0("../results/trends/aerosol_s2_slope_",p,".tif"), overwrite = TRUE)
    writeRaster(trendRasters[[p]][[2]][["pvalue"]], filename = paste0("../results/trends/aerosol_s2_pvalue_",p,".tif"), overwrite = TRUE)
    
    writeRaster(trendRasters[[p]][[3]][["slope"]], filename = paste0("../results/trends/aerosol_s3_slope_",p,".tif"), overwrite = TRUE)
    writeRaster(trendRasters[[p]][[3]][["pvalue"]], filename = paste0("../results/trends/aerosol_s3_pvalue_",p,".tif"), overwrite = TRUE)
    
    writeRaster(trendRasters[[p]][[4]][["slope"]], filename = paste0("../results/trends/aerosol_s4_slope_",p,".tif"), overwrite = TRUE)
    writeRaster(trendRasters[[p]][[4]][["pvalue"]], filename = paste0("../results/trends/aerosol_s4_pvalue_",p,".tif"), overwrite = TRUE)
  }
}

slopes = stack(list.files("../results/trends/", pattern = "aerosol_s._slope*", full.names = TRUE))
pvalues = stack(list.files("../results/trends/", pattern = "aerosol_s._pvalue*", full.names = TRUE))
