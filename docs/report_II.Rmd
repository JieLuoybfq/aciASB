...
of 31km at the ground, however the data has been regridded to 0.25°. Here, we used the 
...
For the fourth season, when controlling for RH, we observer an increase in the correlation 
