...
Areas with missing values are concentrated around the Aral Sea for all seasons (Fig. \ref{fig:cor_aod_p}). 
...
When controlling for RH, some changes can be observed (Fig. \ref{fig:cor_aod_rh}). In the first season,
...
for all four seasons and based on the controlling scenario (Fig. \ref{fig:total_corr}). For all seasons and 
