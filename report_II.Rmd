...
<!-- \begin{landscape} -->
<!-- ```{r prec_yearly, echo=FALSE, fig.align="center", fig.show="hold", out.width="30%", fig.cap="Boxplots for yearly sum of precipitation [mm].", dpi=72} -->
<!-- knitr::include_graphics("../results/plots/P_yearly.png") -->
<!-- ``` -->

<!-- ```{r prec_monthly, echo=FALSE, fig.align="center", fig.show="hold", out.width="30%", fig.cap="Boxplots for monthly sums of precipitation [mm].", dpi=72} -->
<!-- knitr::include_graphics("../results/plots/P_monthly.png") -->
<!-- ``` -->

<!-- ```{r rh_yearly, echo=FALSE, fig.align="center", fig.show="hold", out.width="30%", fig.cap="Boxplots for yearly median of relative humididty [%].", dpi=72} -->
<!-- knitr::include_graphics("../results/plots/RH_yearly.png") -->
<!-- ``` -->

<!-- ```{r rh_monthly, echo=FALSE, fig.align="center", fig.show="hold", out.width="100%", fig.cap="Boxplots for monthly median relative humidity [%].", dpi=72} -->
...
```{r cor_aod_p, echo=FALSE, fig.align="center", fig.pos="H", out.width="60%", fig.cap="Spatial distribution of correlation coefficient rho between AOD and P during spring (a), summer (b), autumn (c), and winter (d).", dpi=72}
...
```{r cor_aod_p_cer, echo=FALSE, fig.align="center", fig.pos="H", out.width="60%", fig.cap="Spatial distribution of correlation coefficient rho between AOD and P controlled for CER during spring (a), summer (b), autumn (c), and winter (d).", dpi=72}
